...
func ShowHelpPage(g *core.EC2) {
	helpPage := newHelpPage(g)

	g.TView.SetFocus(helpPage.Grid)
	g.PageHolder.AddPage(utils.HelpPageID, helpPage.Grid, true, true)
}

// newHelpPage : Creates a new help page.
func newHelpPage(g *core.EC2) *HelpPage {
